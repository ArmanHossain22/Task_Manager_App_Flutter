...
class _ForgotPasswordEmailScreenState extends State<ForgotPasswordEmailScreen> {
  ...
  final ForgotPasswordEmailProvider _forgotPasswordEmailProvider =
      ForgotPasswordEmailProvider();

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => _forgotPasswordEmailProvider,
      child: Scaffold(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Consumer(
                    builder: (context, ForgotPasswordEmailProvider value, child){
                      return Visibility(
                        visible:
                        !_forgotPasswordEmailProvider.forgotPasswordInProgress,
  ...
  Future<void> _forgotPasswordRecovery() async {
    ...
    final bool isSuccess = await _forgotPasswordEmailProvider
        .forgotPasswordRecovery(email);
    ...
    if (isSuccess) {
      ...
      showSnackBarMessage(context, _forgotPasswordEmailProvider.errorMessage!);
    }
  }
}
